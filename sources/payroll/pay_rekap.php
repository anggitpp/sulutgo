			...
			\">FILTER</legend>
				...
				<table width=\"100%\">
					...
					<p>
						...
						<div class=\"field\">
							".comboData("select * from mst_data where statusData='t' and kodeCategory='X03' order by urutanData","kodeData","namaData","par[idLokasi]","ALL",$par[idLokasi],"onchange=\"document.getElementById('form').submit();\"", "90%", "chosen-select")."
						</div>
					</p>
					<p>
