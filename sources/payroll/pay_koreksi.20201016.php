<?php
	...
	function lihat(){
		...
		$text.="</tr>
			...
			$filter = "where t1.bulanKoreksi='$par[bulanKoreksi]' and t1.tahunKoreksi='$par[tahunKoreksi]' AND t2.group_id IN ( $areaCheck )";		
	...
	function pegawai(){
		...
		$filter = "where reg_no is not null AND group_id IN ( $areaCheck ) ";
