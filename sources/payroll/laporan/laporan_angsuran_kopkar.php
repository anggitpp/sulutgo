...
function lihat()
{
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="dyntable">
            ...
            $sql = "SELECT x1.nilaiUpload, t1.id, t1.join_date, t1.name, t2.div_id from pay_upload x1 join emp t1 on x1.idPegawai = t1.id join emp_phist t2 on (t1.id = t2.parent_id AND t2.status = '1') $filter group by t1.id, x1.keteranganUpload order by name";
            $res = db($sql);
            $no = 0;
...
function xls()
{
    ...
    $field = array("no",  "nama", "cabang/unit kerja", "jumlah");
    ...
    exportXLS($direktori, $namaFile, $judul, 4, $field, $data, true, 3, array("TOTAL\tright",getAngka($totalNilai)."\t right"));
}
