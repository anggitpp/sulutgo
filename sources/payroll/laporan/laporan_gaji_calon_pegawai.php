...
function lihat()
{
    ...
    $sql = "SELECT t1.idPegawai, t1.nilaiProses, t2.kodeKomponen FROM pay_proses_".$par[tahunData].$par[bulanData]." t1 join dta_komponen t2 on t1.idKomponen = t2.idKomponen WHERE t2.kodeKomponen IN ('GPF', 'TJF')";
    $res = db($sql);
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="dyntable">
            ...
            <tbody>
            <?php
            $filter = "WHERE t1.status = '535' AND t1.cat = '3636'";
            ...
            while ($r = mysql_fetch_assoc($res)) {
                ...
                $tunjanganJabatan = $arrNilai[$r[id]]["TJF"];
