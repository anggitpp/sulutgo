...
function lihat()
{
    ...
    $sql = "SELECT t1.idPegawai, t1.nilaiUpload, t2.kodeKomponen FROM pay_upload t1 join dta_komponen t2 on t1.idKomponen = t2.idKomponen WHERE t1.bulanUpload = '$par[bulanData]' AND t1.tahunUpload = '$par[tahunData]' AND t2.kodeKomponen IN ('P40', 'P41')";
    $res = db($sql);
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="dyntable">
            ...
            while ($r = mysql_fetch_assoc($res)) {
                if(!empty(isset($arrNilai[$r[id]]))){
                    ...
                    $iuranPerusahaan = $arrNilai[$r[id]]['P40'];
                    $iuranPegawai = $arrNilai[$r[id]]['P41'];
