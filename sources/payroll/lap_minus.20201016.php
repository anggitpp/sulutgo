<?php
	...
	function xls(){		
		...
		$objPHPExcel->getActiveSheet()->setCellValue('A1', 'LAPORAN PROSES (MINUS)');
		...
		$objPHPExcel->getActiveSheet()->setCellValue('F4', 'GAJI');
		...
		$objPHPExcel->getActiveSheet()->getStyle('A5:F'.$rows)->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_TOP);
