...
if ($_GET["json"] == 'excel') {
  ...
  $res = $emp->exportToExcelReportEmpStat($cyear, $cmonth, $cLocId, $cDivId, $cDeptId, $cUnitId);
  ...
  $uie->exportXLS($res, array("Laporan Jumlah Pegawai per Jabatan",
   ...
   ), "laporan_rekap_status_karyawan_" . uniqid() . ".xlsx");
}
...
if ($_GET["json"] == 1) {
  ...
  echo $emp->loadTableReportEmpStat($cyear, $cmonth, $locId, $divId, $deptId, $unitId);
  exit();
}
?>
