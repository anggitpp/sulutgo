    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="dyntable">
            ...
            <tr>
                ...
                <th width="80">TMT Bekerja</th>
                <th width="80">Tgl. Lahir</th>
                <th width="150">Jabatan</th>
                <th width="100">Gaji Bruto per Jan <?= $par[tahunData] ?></th>
            </tr>
            </thead>
            <tbody>
            <?php
            $filter = "WHERE t1.status ='535' AND $par[tahunData] - year(birth_date) = '58'";
            ...
            while ($r = mysql_fetch_assoc($res)) {
                ...
                $gajiBruto = $gajiPokok + $tunjanganJabatan;
                $no++;
                ?>
                <tr>
                    <td><?= $no ?>.</td>
...
function xls()
{
    ...
    $field = array("no", "nama", "ID", "unit kerja", "pangkat","tmt bekerja", "tanggal lahir", "jabatan", "gaji bruto per januari ".$par[tahunData]."");
