...
function lihat(){
	...
	<div id=\"contentwrapper\" class=\"contentwrapper\">			
		...
		$pria = getField("select count(t1.id) from emp t1 join emp_phist t2 on t1.id = t2.parent_id where upper(t1.gender) = 'M' AND cat = '531' $filter");
		$wanita = getField("select count(t1.id) from emp t1 join emp_phist t2 on t1.id = t2.parent_id where upper(t1.gender) = 'F' AND cat = '531' $filter");
...
function xls(){		
	...
	$rows = 5;
		...
		$pria = getField("select count(t1.id) from emp t1 join emp_phist t2 on t1.id = t2.parent_id where upper(t1.gender) = 'M' t1.cat ='531' $filter");
		$wanita = getField("select count(t1.id) from emp t1 join emp_phist t2 on t1.id = t2.parent_id where upper(t1.gender) = 'F' t1.cat ='531' $filter");
