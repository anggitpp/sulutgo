...
function getPlafon(getPar){	
	...
	rmb_cat=document.getElementById("inp[rmb_cat]").value;
	rmb_type=document.getElementById("inp[rmb_type]").value;
	...
	xmlHttp.open("GET", "ajax.php?par[mode]=plf&par[parent_id]=" + parent_id + "&par[rmb_date]=" + rmb_date + "&par[rmb_cat]=" + rmb_cat + "&par[rmb_type]=" + rmb_type + getPar, true);
	xmlHttp.send(null);
	return false;
