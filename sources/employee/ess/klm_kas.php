<?php
	...
	function lihat(){
		...
		$filter = "where year(t1.tanggalKas)='$par[tahun]'";
		...
		$sql="select t1.*, t2.name, t2.reg_no from ess_kas t1 left join emp t2 on (t1.idPegawai=t2.id) $filter order by t1.nomorKas";
		$res=db($sql);
		while($r=mysql_fetch_array($res)){			
			...
			$text.="<tr>
					...
					<td align=\"center\">$persetujuanKas</td>
					<td align=\"center\">$sdmKas</td>
					<td align=\"center\">$pembayaranKas</td>
					<td align=\"center\">";
