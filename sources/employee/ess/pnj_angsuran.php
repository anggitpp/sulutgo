<?php
	...
	function detail(){
		...
		$sql="select * from ess_pinjaman where idPegawai='$par[idPegawai]' and persetujuanPinjaman='t' and sdmPinjaman='t' and idPinjaman = '$par[idPinjaman]'";
		$res=db($sql);
	...
	function lihat(){
		...
		$filter = "where year(t1.tanggalPinjaman)='$par[tahunPinjaman]' and persetujuanPinjaman='t' and sdmPinjaman='t' AND idPegawai = '$cID'";	
