<?php
	...
	function detail(){
		...
		<td width=\"45%\">
		<p>
		<label class=\"l-input-small\">Tipe Ekstra</label>
		<span class=\"field\">
		".getField("select namaEkstra from dta_ekstra where idEkstra='".$r[idTipe]."'")."&nbsp;
		</span>
		</p>
		<p>
		<label class=\"l-input-small\">Tanggal Ekstra</label>
		<span class=\"field\">
		".getTanggal($r[penggantiEkstra], "t")." <strong>s.d</strong> ".getTanggal($r[selesaiEkstra], "t")."
		</span>
		</p>
		<div style=\"padding-bottom:5px; border-bottom:solid 1px #eee;\">
		<p>
		<label class=\"l-input-small\">Jatah Ekstra</label>
		<span>
		<div style=\"float:left; width:125px;\">".getAngka($r[jatahEkstra])." hari</div>
		<span>
		<label class=\"l-input-small\">&nbsp;&nbsp;&nbsp;Pengambilan</label>
		".getAngka($r[jumlahEkstra])." hari
		</span>
		</span>
		</p>
		</div>											
		<p>
		<label class=\"l-input-small\">Sisa Ekstra</label>
		<span class=\"field\">
		".getAngka($r[sisaEkstra])." hari
		</span>
		</p>
		</td>
		<td width=\"55%\">";
