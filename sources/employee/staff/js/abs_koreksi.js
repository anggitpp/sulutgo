...
function cekMasuk(){
	...
	jam = document.getElementById("masukKoreksi").value.substr(0,2);
	menit = document.getElementById("masukKoreksi").value.substr(3,2);

	jumlahMenit = (jam * 60) + (menit * 1);

	if(jumlahMenit > 720){
		alert("Koreksi absen ini akan mengurangi jatah cuti");
	}
...
function cekPulang(){
	...
	jam2 = document.getElementById("pulangKoreksi").value.substr(0,2);
	menit2 = document.getElementById("pulangKoreksi").value.substr(3,2);

	jumlahMenit2 = (jam2 * 60) + (menit2 * 1);

	if(jumlahMenit2 > 480 && jumlahMenit2 < 780){
		alert("Koreksi absen ini akan mengurangi jatah cuti");
	}
}