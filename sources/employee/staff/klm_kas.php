<?php
	...
	function form(){
		...
		$sTrue = $r[pembayaranKas] == "t" ? "checked=\"checked\"" : "";
			...
			$text.="<div class=\"widgetbox\">
					...
					<td width=\"45%\">
						...
						<p>
							<label class=\"l-input-small\">Status</label>
							<div class=\"fradio\">
								<input type=\"radio\" id=\"true\" name=\"inp[pembayaranKas]\" value=\"t\" $sTrue /> <span class=\"sradio\">Disetujui</span>
								<input type=\"radio\" id=\"false\" name=\"inp[pembayaranKas]\" value=\"f\" $sFalse /> <span class=\"sradio\">Ditolak</span>
								<input type=\"radio\" id=\"revisi\" name=\"inp[pembayaranKas]\" value=\"r\" $sRevisi /> <span class=\"sradio\">Diperbaiki</span>
							</div>
						</p>
						<p>
							<label class=\"l-input-small\">Keterangan</label>
	...
	function lihat(){
		...
		$filter = "where year(t1.tanggalKas)='$par[tahun]' and (leader_id='".$par[idPegawai]."' or administration_id='".$par[idPegawai]."')";		
		if(!empty($par[filter]))		
		$filter.= " and (
		...
		while($r=mysql_fetch_array($res)){			
			...
			$text.="<tr>
					...
					<td align=\"center\"><a href=\"".$persetujuanLink."\" title=\"Detail Data\">$persetujuanKas</a></td>
					<td align=\"center\"><a href=\"#\" onclick=\"openBox('popup.php?par[mode]=detSdm&par[idKas]=$r[idKas]".getPar($par,"mode,idKas")."',750,425);\" >$sdmKas</a></td>
					<td align=\"center\"><a href=\"#\" onclick=\"openBox('popup.php?par[mode]=detPay&par[idKas]=$r[idKas]".getPar($par,"mode,idKas")."',750,425);\" >$pembayaranKas</a></td>
					<td align=\"center\">";
