<?php
	...
	function sdm(){
		...
		$sql="update att_pelatihan set idPegawai='$inp[idPegawai]', idPengganti='$inp[idPengganti]', idAtasan='$inp[idAtasan]', nomorPelatihan='$inp[nomorPelatihan]', tanggalPelatihan='".setTanggal($inp[tanggalPelatihan])."', mulaiPelatihan='".setTanggal($inp[mulaiPelatihan])."', selesaiPelatihan='".setTanggal($inp[selesaiPelatihan])."', keteranganPelatihan='$inp[keteranganPelatihan]', notePelatihan='$inp[notePelatihan]', sdmPelatihan='$inp[sdmPelatihan]', sdmBy='$cUsername', sdmTime='".date('Y-m-d H:i:s')."' where idPelatihan='$par[idPelatihan]'";
		db($sql);
	...
	function approve(){
		...
		$sql="update att_pelatihan set idPegawai='$inp[idPegawai]', idPengganti='$inp[idPengganti]', idAtasan='$inp[idAtasan]', nomorPelatihan='$inp[nomorPelatihan]', tanggalPelatihan='".setTanggal($inp[tanggalPelatihan])."', mulaiPelatihan='".setTanggal($inp[mulaiPelatihan])."', selesaiPelatihan='".setTanggal($inp[selesaiPelatihan])."', keteranganPelatihan='$inp[keteranganPelatihan]', catatanPelatihan='$inp[catatanPelatihan]', persetujuanPelatihan='$inp[persetujuanPelatihan]', approveBy='$cUsername', approveTime='".date('Y-m-d H:i:s')."' where idPelatihan='$par[idPelatihan]'";
		db($sql);
	...
	function form(){
		...
		$true = $r[persetujuanPelatihan] == "t" ? "checked=\"checked\"" : "";
		$false = $r[persetujuanPelatihan] == "f" ? "checked=\"checked\"" : "";
		$revisi = $r[persetujuanPelatihan] == "r" ? "checked=\"checked\"" : "";
		
		$sTrue = $r[sdmPelatihan] == "t" ? "checked=\"checked\"" : "";
		$sFalse = $r[sdmPelatihan] == "f" ? "checked=\"checked\"" : "";
		$sRevisi = $r[sdmPelatihan] == "r" ? "checked=\"checked\"" : "";
			...
			$text.="<div class=\"widgetbox\">
					...
					<td width=\"45%\">
						<p>
							...
							<div class=\"fradio\">
								<input type=\"radio\" id=\"true\" name=\"inp[persetujuanPelatihan]\" value=\"t\" $true /> <span class=\"sradio\">Disetujui</span>
								<input type=\"radio\" id=\"false\" name=\"inp[persetujuanPelatihan]\" value=\"f\" $false /> <span class=\"sradio\">Ditolak</span>
								<input type=\"radio\" id=\"revisi\" name=\"inp[persetujuanPelatihan]\" value=\"r\" $revisi /> <span class=\"sradio\">Diperbaiki</span>
							</div>
						</p>
						<p>
							<label class=\"l-input-small\">Keterangan</label>
							<div class=\"field\">
								<textarea id=\"inp[catatanPelatihan]\" name=\"inp[catatanPelatihan]\" rows=\"3\" cols=\"50\" class=\"longinput\" style=\"height:50px; width:300px;\">$r[catatanPelatihan]</textarea>
							</div>
						</p>
					</td>
					<td width=\"55%\">&nbsp;</td>
			...
			$text.="<div class=\"widgetbox\">
					...
					<td width=\"45%\">
						<p>
							<label class=\"l-input-small\">Status</label>
							<div class=\"fradio\">
								<input type=\"radio\" id=\"true\" name=\"inp[sdmPelatihan]\" value=\"t\" $sTrue /> <span class=\"sradio\">Disetujui</span>
								<input type=\"radio\" id=\"false\" name=\"inp[sdmPelatihan]\" value=\"f\" $sFalse /> <span class=\"sradio\">Ditolak</span>
								<input type=\"radio\" id=\"revisi\" name=\"inp[sdmPelatihan]\" value=\"r\" $revisi /> <span class=\"sradio\">Diperbaiki</span>
							</div>
						</p>
						<p>
							<label class=\"l-input-small\">Keterangan</label>
							<div class=\"field\">
								<textarea id=\"inp[notePelatihan]\" name=\"inp[notePelatihan]\" rows=\"3\" cols=\"50\" class=\"longinput\" style=\"height:50px; width:300px;\">$r[notePelatihan]</textarea>
							</div>
						</p>
					</td>
					<td width=\"55%\">&nbsp;</td>
	...
	function lihat(){
		...
		$filter = "where year(t1.tanggalPelatihan)='$par[tahunPelatihan]' and (leader_id='".$par[idPegawai]."' or administration_id='".$par[idPegawai]."')";
		if(!empty($par[filter]))		
		$filter.= " and (
		...
		$sql="select * from att_pelatihan t1 left join dta_pegawai t2 on (t1.idPegawai=t2.id) $filter order by t1.nomorPelatihan";
		$res=db($sql);
		while($r=mysql_fetch_array($res)){			
			...
			$persetujuanLink = isset($menuAccess[$s]["edit"]) ? "?par[mode]=app&par[idPelatihan]=$r[idPelatihan]".getPar($par,"mode,idPelatihan") : "#";			
			#$sdmLink = isset($menuAccess[$s]["edit"]) ? "?par[mode]=sdm&par[idPelatihan]=$r[idPelatihan]".getPar($par,"mode,idPelatihan") : "#";
			$sdmLink = "#";
			...
			$text.="<tr>
					...
					<td align=\"center\"><a href=\"".$persetujuanLink."\" title=\"Detail Data\">$persetujuanPelatihan</a></td>
					<td align=\"center\"><a href=\"".$sdmLink."\" title=\"Detail Data\">$sdmPelatihan</a></td>
					<td align=\"center\">
						<a href=\"?par[mode]=det&par[idPelatihan]=$r[idPelatihan]".getPar($par,"mode,idPelatihan")."\" title=\"Detail Data\" class=\"detail\"><span>Detail</span></a>
					</td>";
	...
	function detail(){
		...
		$text.="<div class=\"pageheader\">
			...
			$persetujuanPelatihan = $r[persetujuanPelatihan] == "r" ? "Diperbaiki" : $persetujuanPelatihan;	
			...
			$sdmPelatihan = $r[sdmPelatihan] == "r" ? "Diperbaiki" : $sdmPelatihan;
