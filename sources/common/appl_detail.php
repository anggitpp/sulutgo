  ...
  <div id="contentwrapper" class="contentwrapper">
    <form id="myForm" class="stdform" enctype="multipart/form-data">
          ...
          <tr>
            <td  style="width: 50%">
              <p>
                ...
                <span class="field" style="margin-left: 50%">&nbsp;&nbsp;<?= $appl->tglInput == "" ? "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" : $appl->tglInput ?></span>
              </p>
            </td>
            <td  style="width: 50%">
              <p>
      ...
      <fieldset>
        ...
        <table width="100%">
        <?php $psikotest = getField("select count(id) from rec_selection_appl where phase_id = '603' AND sel_status = '601' AND appl_id = '".$appl->id."'"); ?>
          <tr>
            <td  style="width: 80%">
              <p>
                ...
                <input type="checkbox" id="vselStatus" name="vselStatus" <?= ($applVer->selStatus == "1" ? "checked=checked" : "") ?> value="1" disabled="disabled" /><span>&nbsp;&nbsp;&nbsp;&nbsp;Seleksi&nbsp;&nbsp;&nbsp;&nbsp;</span>
                 <input type="checkbox" id="vpsikotest" name="vpsikotest" <?= ($psikotest == "1" ? "checked=checked" : "") ?> value="1" disabled="disabled" /><span>&nbsp;&nbsp;&nbsp;&nbsp;Psikotest&nbsp;&nbsp;&nbsp;&nbsp;</span>
            ...
            <td  style="width: 100%">
              <p><br>
                ...
                <span class="fieldB">
                  ...
                  if($_GET[hh]==1){
                    $applVer->lastStatus = 2;
                    echo $cutil->generateRadioArrayFlex(array(0 => "Tidak Disarankan", 1 => "Disarankan",2=>"Sedang di Proses"), "vlastStatus", $applVer->lastStatus, " disabled='disabled'");
                  }else{
                    echo $cutil->generateRadioArrayFlex(array(0 => "Tidak Disarankan", 1 => "Disarankan",), "vlastStatus", $applVer->lastStatus, " disabled='disabled'");
                  }
                     ?>
      ...
      <ul class="hornav">
        ...
        <li><a href="#tab_5">Pelatihan</a></li>
        <li><a href="#tab_6">File</a></li>
      </ul>
      ...
      <div id="tab_1" class="subcontent" style="margin:0">
        <table width="100%">
          <tr>
            <td width="50%">
              <p>
                <label class="l-input-small2">ID Pelamar</label>
...
//          var_dump($redu);
            ...
            foreach ($redu as $r) {
              ...
              $rowTmpl.= "<td style=\"text-align: center;\">" . ($r["eduFilename"] != "" ? "<a onclick=\"openBox('view.php?doc=pend&id=".$r["eduFilename"]."',900,500);\">" . "<img src=\"" . getIcon($r["eduFilename"]) . "\" align=\"center\" style=\"vertical-align:middle\" >" . "</a>" : "") . "</td>";
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="pworktable">
          ...
          <tbody>
            ...
            foreach ($rpwork as $r) {
              ...
              $rowTmpl.= "<td style=\"text-align: center;\">" . ($r["filename"] != "" ? "<a onclick=\"openBox('view.php?doc=ahli&id=".$r["filename"]."',900,500);\">" . "<img src=\"" . getIcon($r["filename"]) . "\" align=\"center\" style=\"vertical-align:middle\" >" . "</a>" : "") . "</td>";
...
//              $rowTmpl.= "</td>";
      ...
      <div id="tab_5" class="subcontent" style="margin:0;display: none">
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="ptraintable">
        <thead>
          <tr>
            <th>Lembaga</th>
            <th>Nama Training</th>
        ...
        <tbody>
          <?php
          $applPtrain = new RecApplicantPtrain();
          $rptrain = $applPtrain->getPtrainByParentId($appl->id);
          $ptno = 0;
          foreach ($rptrain as $r) {
           
            $dataTmpl = "&r1=" . urlencode($r["name"]);
            $dataTmpl.= "&r2=" . urlencode($r["training"]);
            $dataTmpl.= "&r3=" . urlencode($r["position"]);
            $dataTmpl.= "&r4=" . urlencode($r["start"]);
            $dataTmpl.= "&r5=" . urlencode($r["ends"]);
            $dataTmpl.= "&r6=" . urlencode($r["location"]);
            $dataTmpl.= "&r7=" . urlencode($r["filename"]);
            $dataTmpl.= "&r8=" . urlencode($r["remark"]);
            $rowTmpl = "<tr id='pTrainRow_" . $ptno . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainId_" . $ptno . "' name='pTrainId[]' value='" . $r["id"] . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainName_" . $ptno . "' name='pTrainName[]' value='" . $r["name"] . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainTraining_" . $ptno . "' name='pTrainTraining[]' value='" . $r["training"] . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainPosition_" . $ptno . "' name='pTrainPosition[]' value='" . $r["position"] . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainStart_" . $ptno . "' name='pTrainStart[]' value='" . $r["start"] . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainEnds_" . $ptno . "' name='pTrainEnds[]' value='" . $r["ends"] . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainLocation_" . $ptno . "' name='pTrainLocation[]' value='" . $r["location"] . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainFilename_" . $ptno . "' name='pTrainFilename[]' value='" . $r["filename"] . "'>";
            $rowTmpl.="<input type='hidden' id='pTrainRemark_" . $ptno . "' name='pTrainRemark[]' value='" . $r["remark"] . "'>";
            $rowTmpl.= "<td>" . $r["name"] . "</td>";
            $rowTmpl.= "<td>" . $r["training"] . "</td>";
            $rowTmpl.= "<td>" . $r["position"] . "</td>";
            
              
            $rowTmpl.= "<td style=\"text-align: center;\">" . $r["lamaTrain"] . "</td>";

            $rowTmpl.= "<td style=\"text-align: center;\">" . ($r["filename"] != "" ? "<a onclick=\"openBox('view.php?doc=train&id=".$r["filename"]."',900,500);\">" ."<img src=\"" . getIcon($r["filename"]) . "\" align=\"center\" style=\"vertical-align:middle\" >"."</a>" : "") . "</td>";
    ...
    <div id="tab_6" class="subcontent" style="margin:0;display: none">
      
      <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="pfiletable">
        <thead>
          <tr>
        ...
        <tbody>
          <?php
          $applPfile = new RecApplicantPfile();
          $rpfile = $applPfile->getPfileByParentId($appl->id);
          $pfno = 0;
          foreach ($rpfile as $r) {
           
            $dataTmpl = "&r1=" . urlencode($r["name"]);
            $dataTmpl.= "&r2=" . urlencode($r["filename"]);
            $dataTmpl.= "&r3=" . urlencode($r["remark"]);
            $rowTmpl = "<tr id='pFileRow_" . $pfno . "'>";
            $rowTmpl.="<input type='hidden' id='pFileId_" . $pfno . "' name='pFileId[]' value='" . $r["id"] . "'>";
            $rowTmpl.="<input type='hidden' id='pFileName_" . $pfno . "' name='pFileName[]' value='" . $r["name"] . "'>";
            $rowTmpl.="<input type='hidden' id='pFileFilename_" . $pfno . "' name='pFileFilename[]' value='" . $r["filename"] . "'>";
            $rowTmpl.="<input type='hidden' id='pFileRemark_" . $pfno . "' name='pFileRemark[]' value='" . $r["remark"] . "'>";
            $rowTmpl.= "<td>" . $r["name"] . "</td>";
            $rowTmpl.= "<td style=\"text-align: center;\">" . ($r["filename"] != "" ? "<a onclick=\"openBox('view.php?doc=pfile&id=".$r["filename"]."',900,500);\">" ."<img src=\"" . getIcon($r["filename"]) . "\" align=\"center\" style=\"vertical-align:middle\" >"."</a>" : "") . "</td>";
