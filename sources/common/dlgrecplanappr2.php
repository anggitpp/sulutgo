...
if (isset($_POST["btnSimpan"])) {
  $apprSta = $_POST["apprSdmSta"];
  $apprDate = $_POST["apprSdmDate"];
  $apprRem = $_POST["apprSdmRemark"];
  $eid = $_SESSION["entity_id"];
  $sql = " UPDATE rec_plan SET appr_sdm_sta='$apprSta', appr_sdm_by='$cUsername', appr_sdm_date='$apprDate', appr_sdm_remark='$apprRem' WHERE id='$eid'";
//  echo $sql;
  $cutil->execute($sql);
...
$__validate["items"] = array(
    "apprSdmSta" => array("rule" => "required", "msg" => "Field Status harus diisi.."),
    "apprSdmDate" => array("rule" => "required", "msg" => "Field Tanggal harus diisi.."),
);
  ...
  <?php if (isset($menuAccess[$s]["apprlv2"])) { ?>
    <div id="contentwrapper" class="contentwrapper" style="margin-top: -60px;">
      <form id="apprForm"  action="<?php echo preg_replace("/&id=\d+/", "", preg_replace("/&modedf=\w+/", "", $_SERVER["REQUEST_URI"])) ?>" method="post" class="stdform">
        <div class="widgetbox">
          <div class="contenttitle2"><h3>Approval SDM</h3></div>
          <p id="p0">
            <label class="l-input-small">Approve By&nbsp;&nbsp;</label>
            <span class="field"><?= $cUsername ?>&nbsp;</span>
          </p>
          <p id="p0"><?= $ui->createLabelSpanInputAttr("Tanggal", $e->apprSdmDate, "apprSdmDate", "apprSdmDate", "hasDatePicker2", " style='width:20%;' ") ?></p>
          <p id="p0">
            <label class="l-input-small">Status&nbsp;&nbsp;</label>
            <span class="fieldB"><?= $cutil->generateSelectArray2(array(1 => "Ditolak", 2 => "Pending", 3 => "Disetujui"), "apprSdmSta", $e->apprSdmSta) ?></span>
          </p>
          <p id="p0"><?= $ui->createLabelSpanInputAttr("Keterangan", $e->apprSdmRemark, "apprSdmRemark", "apprSdmRemark", "", " style='width:60%;' ") ?></p>
          <center>
      ...
      <form id="apprForm"  action="<?php echo preg_replace("/&id=\d+/", "", preg_replace("/&modedf=\w+/", "", $_SERVER["REQUEST_URI"])) ?>" method="post" class="stdform">
        <div class="widgetbox">
          ...
          <p id="p0">
            ...
            <span class="field"><?= $e->apprSdmDate ?>&nbsp;</span>
          </p>
          <p id="p0">
            <label class="l-input-small">Status&nbsp;&nbsp;</label>
          ...
          <p id="p0">
            ...
            <span class="field"><?= $e->apprSdmRemark ?>&nbsp;</span>
          </p>
          <center>
            <p class="stdformbutton">
