...
function ubah(){
	...
	repField();
	$fotoUser = fotoUser();
	$sql="update app_user set username='".trim($inp[username])."', kodeGroup='$inp[kodeGroup]', idPegawai='$inp[idPegawai]', namaUser='$inp[namaUser]', keteranganUser='$inp[keteranganUser]', fotoUser='$fotoUser', statusUser='$inp[statusUser]', updateBy='$cUsername', updateTime='".date('Y-m-d H:i:s')."' where username='$par[username]'";
	db($sql);				
...
function tambah(){
	...
	repField();
	$fotoUser = fotoUser();
	$sql="insert into app_user (username, kodeGroup, idPegawai, password, namaUser, keteranganUser, fotoUser, statusUser, createBy, createTime) values ('".trim($inp[username])."', '$inp[kodeGroup]', '$inp[idPegawai]', '".encodePass($inp[password])."', '$inp[namaUser]', '$inp[keteranganUser]', '$fotoUser', '$inp[statusUser]', '$cUsername', '".date('Y-m-d H:i:s')."')";
	db($sql);
