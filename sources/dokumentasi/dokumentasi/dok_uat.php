...
function xls2(){		
	...
	while($r=mysql_fetch_array($res)){			
		...
		$sql_ = "
		SELECT * from app_menu where kodeSite = '$r[kodeSite]'
		";
...
function xls(){		
	...
	$sql = " SELECT t1.*,t2.id, t2.fileUat, t2.fileBa, t2.filePlk,t2.status,t2.tanggalPlk FROM app_modul t1 left join doc_uat t2 on t1.kodeModul = t2.kodeModul";
