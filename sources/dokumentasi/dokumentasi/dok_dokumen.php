...
<div id=\"contentwrapper\" class=\"contentwrapper\">
	...
	<form action=\"\" method=\"post\" id = \"form\" class=\"stdform\" onsubmit=\"return false;\">
		...
		<div id=\"pos_l\" style=\"float:left;\">
			...
			<p>					
				...
				".comboData("select * from mst_data where kodeCategory = 'KRK' order by urutanData","kodeData","namaData","par[idKategori]","ALL KATEGORI",$par[idKategori],"onchange=\"document.getElementById('form').submit();\"","210px;","chosen-select")."
			</p>
	...
	// echo $sLimit;
		...
		if(!empty($par[idKategori])){
			$filters.=" and t1.kategori_dokumen = '$par[idKategori]'";
		}
	...
	$text.="<div class=\"centercontent contentpopup\">
		...
		<table style=\"width: 100%\">
			...
			<p>
				...
				<div class=\"field\">
					".comboData("select * from mst_data where statusData='t' and kodeCategory='KRK' order by urutanData","kodeData","namaData","inp[kategori_dokumen]"," ",$r[kategori_dokumen],"onchange=\"getAktifitas('" . getPar($par, "mode,kategori_dokumen") . "');\"", "310px")."
				</div>
			</p>
			<p>
				<label class=\"l-input-small\">Kegiatan</label>
				<div class=\"field\">
					".comboData("select * from doc_rencana where idKategori='$r[kategori_dokumen]'  order by aktifitas","id","aktifitas","inp[kegiatan_dokumen]"," ",$r[kegiatan_dokumen],"", "310px")."
				</div>
			</p>
			</fieldset>
			<fieldset>
