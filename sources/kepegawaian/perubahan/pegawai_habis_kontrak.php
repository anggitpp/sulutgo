...
function lData(){
  ...
  $sWhere = " WHERE id is not null and status = '537'";
 ...
 $sql="SELECT * FROM `emp` $sWhere ORDER BY $orderBy $sLimit";
 ...
 while($r=mysql_fetch_array($res)) {
   $no++;
    ...
    $r['post_name'] = getField("SELECT UPPER(`pos_name`) FROM `emp_phist` WHERE `parent_id` = '$r[id]'");
   ...
   $data=array(
    ...
    "<div align=\"left\">$r[post_name]</div>",
    "<div align=\"center\">".$r[gender]."</div>",
    "<div align=\"center\">".$r[masa_kerja]."</div>",
    // "
    // <div align=\"center\">
