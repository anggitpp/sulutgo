    		...
    		<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"stdtable stdtablequick\" id=\"dataList\" >
    			<thead>
    				<tr>
                        ...
                        <th style=\"vertical-align:middle; min-width:90px;\" rowspan=\"2\">foto</th>
                        ...
                        <th style=\"vertical-align:middle; min-width:75px;\" rowspan=\"2\">kontrol</th>
    				</tr>
                    <tr>
                        ";
...
function lData()
{
	...
	while($r = mysql_fetch_array($res)){
        ...
        foreach($getBulan as $bln)
        {
            ...
            $tombol = "<a href=\"#\" onclick=\"openBox('popup.php?par[mode]=viewData&par[idPenPegawai]=$r[id]&par[idPegawai]=$r[idPegawai]&par[tipePenilaian]=$r[tipePenilaian]&par[kodePenilaian]=$r[kodePenilaian]&par[tahunPenilaian]=$par[idPeriode]&par[bulanPenilaian]=$bln[kodeData]".getPar($par,"mode,idPenPegawai,idPegawai,tipePenilaian,kodePenilaian,tahunPenilaian,bulanPenilaian,idPeriode")."', 1000, 500 )\"><strong>$hasil</strong></a>";
        ...
        $data3 = array(
            "<div align=\"center\"><a href=\"?par[mode]=detail&par[idPenPegawai]=$r[id]&par[idPegawai]=$r[idPegawai]&par[tipePenilaian]=$r[tipePenilaian]&par[kodePenilaian]=$r[kodePenilaian]&par[tahunPenilaian]=$par[idPeriode]&par[bulanPenilaian]=$r[bulanPenilaian]".getPar($par,"mode,idPenPegawai,idPegawai,tipePenilaian,kodePenilaian,tahunPenilaian,bulanPenilaian,idPeriode")."\" title=\"Realisasi\" class=\"detail\"><span>Realisasi</span></a></div>"
            );
                    
        $dataX = array_merge($data1,$data2,$data3);
                            ...
                            foreach($getObj as $obj)
                            {
                                ...
                                <tr>
                                    ...
                                    if(isset($menuAccess[$s]["edit"]) || isset($menuAccess[$s]["delete"])){
            							...
            							if(isset($menuAccess[$s]["edit"])) $text.="<a href=\"#Edit\" title=\"Edit Data\" class=\"edit\"  onclick=\"openBox('popup.php?par[mode]=edit&par[idAspek]=$idAspek&par[id_sasaran]=$obj[idSasaran]&par[id_realisasi]=$rea[id_realisasi]&par[idIndividu]=$sas[idIndividu]".getPar($par,"mode,idAspek,id_realisasi,idIndividu,idSasaran")."',800,600);\"><span>Edit</span></a>";				
