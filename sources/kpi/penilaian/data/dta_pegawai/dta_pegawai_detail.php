	...
	<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="datatable">
		<thead>
			<tr>
				...
				<th width="150" style="vertical-align: middle">KODE PENILAIAN</th>
...
<script type="text/javascript">
	jQuery(document).ready(function(){
		...
		?>
		jQuery("#datatable_wrapper #right_panel").append(" <a href=\"?<?= getPar($par, "mode, idPegawai"); ?>\" class=\"btn btn1 btn_document\"><span>Kembali</span></a>");
