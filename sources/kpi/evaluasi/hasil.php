...
function indexResult()
{
    ...
    <div class="contentwrapper">
        ...
        <div style="position: absolute; top: 0.8rem; right: 1.1rem;">
            ...
            <?php if ($aspect['aspekKode'] == '1') : ?>
                ...
                foreach ($perspectives as $perspective) {
                    ...
                    foreach ($objectives as $objective) {
                        ...
                        $data['objectives'][] = [
                            ...
                            'target' => $target['satuanIndividu'] . " " . $target['targetIndividu'] . " " . $target['keteranganTargetIndividu'] . " " . $target['satuanIndividu2'],
                            'realization' => $target['satuanIndividu'] . " " . $realization['realisasi'] . " " . $target['keteranganTargetIndividu'] . " " . $target['satuanIndividu2'],
                            'achieve' => $realization['pencapaian'],
                            'value' => $result,
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
                    ...
                    <tr>
                        ...
                        <th rowspan="2" style="width: 50px; vertical-align: middle;">saran</th>
                    </tr>
                    <tr>
                                ...
                                <td>
                                    <center>
                                        <?php if ($menuAccess[$s]['edit']) : ?>
                                            <a title="Ubah Data"
                                               class="edit"
                                               onclick="openBox('popup.php?<?= getPar($par, "mode, result_id") ?>&par[mode]=edit&par[realization_id]=<?= $object['id'] ?>', 650, 250);">
                                                <span>Saran</span>
                                            </a>
                                        <?php endif; ?>
                                    </center>
            ...
            <?php if ($aspect['aspekKode'] == '2') : ?>
                ...
                foreach ($perspectives as $perspective) {
                    ...
                    foreach ($objectives as $objective) {
                        ...
                        $data['objectives'][] = [
                            ...
                            'weight' => $target['bobotIndividu'],
                            'attainment' => $realization['pencapaian'] ?: 0,
                            'value' => $result,
                            'result' => $result * ($target['bobotIndividu'] / 100)
                        ];
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
                    ...
                    <tr>
                        ...
                        <th rowspan="2" style="width: 70px; vertical-align: middle;">Pencapaian</th>
                    ...
                    <?php foreach ($datas as $data) : ?>
                        ...
                        <?php foreach ($data['objectives'] as $object) : ?>
                            <tr>
                                ...
                                <td style="vertical-align: middle;">
                                    <center><?= $object['attainment'] ?>%</center>
                                </td>
                                <td style="vertical-align: middle;">
                                    <center><?= $object['value'] ?></center>
                                </td>
        ...
        <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick">
            ...
            <?php foreach ($components as $component) : ?>
                ...
                <tr>
                    ...
                    <td>
                        <center><?= $component['result'] * ($component['weight'] / 100) ?></center>
                    </td>
                </tr>
            <?php endforeach; ?>
            <tr style="background-color: rgba(0, 0, 0, 0.015)">
...
function form()
{
    ...
    $realization = getRow("SELECT * FROM `pen_realisasi_individu` WHERE `id_realisasi` = '$par[realization_id]'");
    ...
    <div id="contentwrapper" class="contentwrapper">
        ...
        <form method="post" action="?<?= getPar($par) ?>" name="form" id="form" class="stdform">
            ...
            <textarea id="inp[saran]" name="inp[saran]" class="mediuminput" placeholder="Saran" style="width:98%; height: 70px"><?= $realization['saran'] ?></textarea>
...
function update()
{
    ...
    WHERE `id_realisasi` = '$par[realization_id]'";
    ...
    echo "<script>parent.window.location='index.php?" . getPar($par, "mode, realization_id") . "&par[mode]=result';</script>";
}