...
function index()
{
        ...
        <div style="overflow-x: auto">
            ...
            <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablequick" id="datatable">
                ...
                <tr>
                    ...
                    <th style="vertical-align:middle;">Nilai Target / Kinerja</th>
                    <th style="vertical-align:middle;">Nilai Perilaku</th>
                    <th rowspan="2" style="vertical-align:middle;" width="80">Total</th>
                    <th rowspan="2" style="vertical-align:middle;" width="120">Yudisium</th>
                </tr>
                <tr>
                    <th width="150">(1-40)</th>
                    <th width="150">(1-10)</th>
                </tr>
                </thead>
                <tbody>
                </tbody>
    ...
    <?= table(9, range(3, 9), "datas", "true", "", "datatable") ?>
...
function export()
{
    ...
    $php_excel->getActiveSheet()->getColumnDimension("F")->setWidth(25);
    $php_excel->getActiveSheet()->getColumnDimension("G")->setWidth(25);
    $php_excel->getActiveSheet()->getColumnDimension("H")->setWidth(14);
    $php_excel->getActiveSheet()->getColumnDimension("I")->setWidth(14);
    ...
    $php_excel->getActiveSheet()->setCellValue("F4", "NILAI TARGET/KINERJA");
    $php_excel->getActiveSheet()->setCellValue("G4", "NILAI PERILAKU");
    $php_excel->getActiveSheet()->setCellValue("H4", "TOTAL");
    $php_excel->getActiveSheet()->setCellValue("I4", "YUDISIUM");

    $php_excel->getActiveSheet()->setCellValue("F5", "(1-40)");
    $php_excel->getActiveSheet()->setCellValue("G5", "(1-10)");
    ...
    $php_excel->getActiveSheet()->mergeCells("H4:H5");
    $php_excel->getActiveSheet()->mergeCells("I4:I5");
    ...
    foreach ($employees as $employee) {
        ...
        $php_excel->getActiveSheet()->setCellValue("F$row", $aspect_1);
        $php_excel->getActiveSheet()->setCellValue("G$row", $aspect_2);
        $php_excel->getActiveSheet()->setCellValue("H$row", $result);
        $php_excel->getActiveSheet()->setCellValue("I$row", $wom['mention'][0]);
