...
function index()
{
    ...
    if ($json == 1) {
        ...
        $ret = [];
        $res = db("SELECT * FROM `pen_pegawai` t1 JOIN `dta_pegawai` t2 ON t2.`id` = t1.`idPegawai` WHERE t1.`tipePenilaian` = '$par[type]' AND t1.`kodePenilaian` = '$par[idKode]' AND t1.`tahunPenilaian` = '$par[period]'");
                            ...
                            foreach ($indicators as $key_indicator => $indicator) : ?>
                                ...
                                foreach ($objectives as $key_objective => $objective) : ?>
                                    ...
                                    <?php if ($par['mode'] == 'det' && $exist) : ?>
                                        <tr style="background-color: <?= $exist['bobotIndividu'] == 0 ? 'rgba(255, 0, 0, 0.05)' : '' ?>">
...
function form()
{
    ...
    $data = KPISetingIndividuObyektif::find($par['idIndividu']);
    $target = KPIMasterObyektif::find($data['idSasaran']);

    $data['settingIndividu'] = $data['settingIndividu'] ?: 't';
    $data['tipeTarget'] = $data['tipeTarget'] ?: 'akumulasi';

    $data['targetIndividu'] = $data['targetIndividu'] ?: $target['targetSasaran'];
    $data['keteranganTargetIndividu'] = $data['keteranganTargetIndividu'] ?: $target['targetSasaran2'];
            ...
            <fieldset style="padding: .5rem; border-radius: .3rem;">
                ...
                <div style="display: flex;">
                    <div style="flex: 1">
                        ...
                        <div class="field">
                            <input type="text" name="inp[targetIndividu]" id="inp[targetIndividu]" class="mediuminput" value="<?= $data['targetIndividu'] ?>" style="width: 50px;">
                            <input type="text" name="inp[keteranganTargetIndividu]" id="inp[keteranganTargetIndividu]" class="mediuminput" value="<?= $data['keteranganTargetIndividu'] ?>" style="width: 150px;">
                        </div>
                        </p>
                    ...
                    <div style="flex: 1">
                        ...
                        <div class="field fradio">
                            <?php foreach ($arr_breakdown as $key => $value) : $checked = $data['settingIndividu'] == $key ? "checked" : ""; ?>
                ...
                <div style="display: flex;">
                    <div style="flex: 1">
                        ...
                        <div class="field">
                            <input type="text" name="inp[satuanIndividu]" id="inp[satuanIndividu]" class="mediuminput" value="<?= $data['satuanIndividu'] ?>" placeholder="Depan" style="width: 100px;">
                            <input type="text" name="inp[satuanIndividu2]" id="inp[satuanIndividu2]" class="mediuminput" value="<?= $data['satuanIndividu2'] ?>" placeholder="Belakang" style="width: 100px;">
                        </div>
                        </p>
                    ...
                    <div style="flex: 1">
                        ...
                        <div class="field fradio">
                            <?php foreach ($arr_target as $key => $value) : $checked = $data['tipeTarget'] == $key ? "checked" : ""; ?>
                ...
                <div style="display: flex;">
                    <div style="flex: 1">
                        ...
                        <div class="field">
                            <textarea name="inp[catatanIndividu]" id="inp[catatanIndividu]" class="mediuminput" style="height: 50px"><?= $data['catatanIndividu'] ?></textarea>
                        </div>
                        </p>
                    ...
                    <div style="flex: 1">
                        ...
                        <div class="field">
                            <input type="text" name="inp[bobotIndividu]" id="inp[bobotIndividu]" class="vsmallinput" value="<?= $data['bobotIndividu'] ?>"> %
                        </div>
                        </p>
                        ...
                        <div class="field">
                            <?= comboArray("inp[intervalIndividu]", ["Bulanan", "Tahunan"], $data['intervalIndividu']) ?>
                        </div>
                        </p>
...
function insert()
{
    ...
    try {
        ...
        $employee = Pegawai::find($par['idPegawai']);

        $objective_ids = collect($inp['objective'])->keys();

        // clear uncheck
        $employee->kpiSetingObyektif()->where('idPeriode', $par['period'])->whereNotIn('idSasaran', $objective_ids)->delete();

        foreach ($objective_ids as $target) {
